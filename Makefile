...
COMPAT_VERS_MACOS=1.0
CURRENT_VERS_MACOS=1.0
...
$(LIB_NAME_MACOS): $(POBJ)
	g++ -dynamiclib -install_name /usr/local/lib/$@ -compatibility_version $(COMPAT_VERS_MACOS) -current_version $(CURRENT_VERS_MACOS) -o $@ $^
	@echo "Built $@ successfully"
